<template>
  <div>
    ...
    <ul>
      ...
      <li>Liaison via API entre l'Intranet et l'outil d'émargement numérique - EduSign</li>
      <li>Développement de la V2 du jeu de gestion d'entreprise "WorldWideCompany"</li>
    </ul>
  </div>
  <br>
  <hr>
